...
export default function Home(){
    ...
    const filteredNotes=notes.filter((note)=>
        note.title.toLowerCase().includes(searchTeam.toLowerCase()) ||
    note.details.toLowerCase().includes(searchTeam.toLocaleLowerCase())
    );
    ...
    return(
        <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 px-6 py-12 flex flex-col items-center">
            <h1 className="text-white text-4xl front-extrabold mb-6 drop-shadow-lg text-center max-w-3xl">
