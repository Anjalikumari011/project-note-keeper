...
export default function Login(){
    ...
    return(
        <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-purple-500 to-pink-500 flex items-center justify-center px-4 ">
            ...
            <p className="text-center text-sm text-white/80">Login to continue</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                <div className="flex flex-col gap-1">
                    ...
                    <input
                     ...
                     required
                     className="w-full px-4 py-3 rounded-xl bg-white/90 text-grey-800 border border-transparent focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 shadow-sm transition duration-200 placeholder-grey-400"
                     />
                </div>
                <div className="flex flex-col gap-1">
                    ...
                    <div className="relative flex w-full rounded-xl bg-white/90 text-grey-800 border border-transparent focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 shadow-sm transition duration-200 placeholder-grey-400">
                       <input
